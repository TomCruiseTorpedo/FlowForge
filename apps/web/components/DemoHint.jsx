...
export default function DemoHint({ onTryPrompt }) {
  return (
    <div className="rounded-xl border border-[hsl(var(--forge-amber-border))] bg-[hsl(var(--forge-amber-bg))] p-4 max-w-2xl mx-auto shadow-lg ring-1 ring-[hsl(38_92%_50%_/_.2)]">
